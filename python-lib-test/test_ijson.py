...
def test_ijson_initial_part(input_filepath):
...
def test_ijson_last_part(input_filepath):
...
def main():
    ...
    #test_ijson_initial_part(input_filepath)
    test_ijson_last_part(input_filepath)

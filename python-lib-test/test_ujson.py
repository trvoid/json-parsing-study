...
def test_ujson_initial_part(input_filepath):
    print('##### Test ujson.load(f) : Get the initial LOT_NUM value #####')
...
def test_ujson_last_part(input_filepath):
    print('##### Test ujson.load(f) : Get the last LOT_NUM value #####')
    print_memory_usage('begin')
    start_time = time.time()
...
def main():
    ...
    #test_ujson_initial_part(input_filepath)
    test_ujson_last_part(input_filepath)

...
def test_bigjson_initial_part(input_filepath):
    print('##### Test bigjson.load() : Get the initial LOT_NUM value #####')
    ...
    with open(input_filepath, 'r') as f:
        ...
        print_memory_usage('after bigjson.load(f)')
...
def test_bigjson_last_part(input_filepath):
    print('##### Test bigjson.load() : Get the last LOT_NUM value #####')
    print_memory_usage('begin')
    start_time = time.time()
...
def main():
    ...
    #test_bigjson_initial_part(input_filepath)
    test_bigjson_last_part(input_filepath)
